...
public class KafkaChannelConfiguration {
  ...
  public static final String TOPIC_CONFIG_PREFIX = KAFKA_PREFIX + "topic.";
  public static final String TOPIC_PARTITIONS = "partitions";
  public static final String TOPIC_REPLICATION_FACTOR = "replication.factor";

  public static final String BOOTSTRAP_SERVERS_CONFIG =
          KAFKA_PREFIX + CommonClientConfigs.BOOTSTRAP_SERVERS_CONFIG;

  public static final String ZOOKEEPER_SERVERS = "zookeepers.servers";
  public static final String ZOOKEEPER_SERVERS_CONFIG = KAFKA_PREFIX + "zookeepers.servers";
